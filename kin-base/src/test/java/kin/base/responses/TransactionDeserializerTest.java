...
public class TransactionDeserializerTest extends TestCase {
  ...
  public void testGetLedgerChanges() {
    ...
    assertEquals("92233720368547.75807", sentAccountTrustLineState.getLimit());
    assertEquals("398200", sentAccountTrustLineState.getBalance());
    ...
    assertEquals("92233720368547.75807", recievedAccountTrustLineState.getLimit());
    assertEquals("803900", recievedAccountTrustLineState.getBalance());
    ...
    assertEquals("92233720368547.75807", sentAccountTrustLineUpdate.getLimit());
    assertEquals("396100", sentAccountTrustLineUpdate.getBalance());
    ...
    assertEquals("92233720368547.75807", receivedAccountTrustLineUpdate.getLimit());
    assertEquals("806000", receivedAccountTrustLineUpdate.getBalance());
