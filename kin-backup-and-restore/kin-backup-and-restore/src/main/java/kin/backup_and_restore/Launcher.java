...
import static kin.backup_and_restore.BackupAndRestoreManager.APP_ID_EXTRA;
import static kin.backup_and_restore.BackupAndRestoreManager.NETWORK_PASSPHRASE_EXTRA;
import static kin.backup_and_restore.BackupAndRestoreManager.NETWORK_URL_EXTRA;
import static kin.backup_and_restore.BackupAndRestoreManager.PUBLIC_ADDRESS_EXTRA;
import static kin.backup_and_restore.BackupAndRestoreManager.STORE_KEY_EXTRA;

import android.app.Activity;
import android.content.Intent;
import android.support.annotation.NonNull;
import kin.backup_and_restore.backup.view.BackupActivity;
import kin.backup_and_restore.restore.view.RestoreActivity;
