...
import com.kin.sdk.recovery.qr.QRBarcodeGenerator;
import com.kin.sdk.recovery.qr.QRBarcodeGenerator.QRBarcodeGeneratorException;
import com.kin.sdk.recovery.qr.QRBarcodeGenerator.QRFileHandlingException;
import com.kin.sdk.recovery.restore.presenter.FileSharingHelper.RequestFileResult;
import com.kin.sdk.recovery.restore.view.UploadQRView;
import com.kin.sdk.recovery.utils.Logger;
