...
import static com.kin.sdk.recovery.events.BackupEventCode.BACKUP_CREATE_PASSWORD_PAGE_BACK_TAPPED;
import static com.kin.sdk.recovery.events.BackupEventCode.BACKUP_CREATE_PASSWORD_PAGE_NEXT_TAPPED;
import static com.kin.sdk.recovery.events.BackupEventCode.BACKUP_CREATE_PASSWORD_PAGE_VIEWED;
import static com.kin.sdk.recovery.events.BackupEventCode.BACKUP_QR_CODE_PAGE_VIEWED;
import static com.kin.sdk.recovery.events.BackupEventCode.BACKUP_QR_PAGE_BACK_TAPPED;
import static com.kin.sdk.recovery.events.BackupEventCode.BACKUP_QR_PAGE_QR_SAVED_TAPPED;
import static com.kin.sdk.recovery.events.BackupEventCode.BACKUP_QR_PAGE_SEND_QR_TAPPED;
import static com.kin.sdk.recovery.events.BackupEventCode.BACKUP_WELCOME_PAGE_BACK_TAPPED;
import static com.kin.sdk.recovery.events.BackupEventCode.BACKUP_WELCOME_PAGE_START_TAPPED;
import static com.kin.sdk.recovery.events.BackupEventCode.BACKUP_WELCOME_PAGE_VIEWED;
import static com.kin.sdk.recovery.events.BroadcastManagerImpl.ACTION_EVENTS_BACKUP;
import static com.kin.sdk.recovery.events.BroadcastManagerImpl.ACTION_EVENTS_RESTORE;
import static com.kin.sdk.recovery.events.RestoreEventCode.RESTORE_ARE_YOUR_SURE_CANCEL_TAPPED;
import static com.kin.sdk.recovery.events.RestoreEventCode.RESTORE_ARE_YOUR_SURE_OK_TAPPED;
import static com.kin.sdk.recovery.events.RestoreEventCode.RESTORE_PASSWORD_DONE_TAPPED;
import static com.kin.sdk.recovery.events.RestoreEventCode.RESTORE_PASSWORD_ENTRY_PAGE_BACK_TAPPED;
import static com.kin.sdk.recovery.events.RestoreEventCode.RESTORE_PASSWORD_ENTRY_PAGE_VIEWED;
import static com.kin.sdk.recovery.events.RestoreEventCode.RESTORE_UPLOAD_QR_CODE_BACK_TAPPED;
import static com.kin.sdk.recovery.events.RestoreEventCode.RESTORE_UPLOAD_QR_CODE_BUTTON_TAPPED;
import static com.kin.sdk.recovery.events.RestoreEventCode.RESTORE_UPLOAD_QR_CODE_PAGE_VIEWED;

import android.content.Intent;
import android.support.annotation.NonNull;
import android.support.annotation.Nullable;
import com.kin.sdk.recovery.BackupEvents;
import com.kin.sdk.recovery.RestoreEvents;
import com.kin.sdk.recovery.events.BroadcastManager.Listener;
