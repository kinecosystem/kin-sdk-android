...
import static kin.recovery.events.BackupEventCode.BACKUP_CREATE_PASSWORD_PAGE_BACK_TAPPED;
...
import static kin.recovery.events.BackupEventCode.BACKUP_QR_CODE_PAGE_VIEWED;
import static kin.recovery.events.BackupEventCode.BACKUP_QR_PAGE_BACK_TAPPED;
import static kin.recovery.events.BackupEventCode.BACKUP_QR_PAGE_QR_SAVED_TAPPED;
import static kin.recovery.events.BackupEventCode.BACKUP_QR_PAGE_SEND_QR_TAPPED;
import static kin.recovery.events.BackupEventCode.BACKUP_WELCOME_PAGE_BACK_TAPPED;
...
import static kin.recovery.events.BroadcastManagerImpl.ACTION_EVENTS_BACKUP;
import static kin.recovery.events.BroadcastManagerImpl.ACTION_EVENTS_RESTORE;
import static kin.recovery.events.RestoreEventCode.RESTORE_ARE_YOUR_SURE_CANCEL_TAPPED;
import static kin.recovery.events.RestoreEventCode.RESTORE_ARE_YOUR_SURE_OK_TAPPED;
...
import static kin.recovery.events.RestoreEventCode.RESTORE_UPLOAD_QR_CODE_BACK_TAPPED;
import static kin.recovery.events.RestoreEventCode.RESTORE_UPLOAD_QR_CODE_BUTTON_TAPPED;
import static kin.recovery.events.RestoreEventCode.RESTORE_UPLOAD_QR_CODE_PAGE_VIEWED;
...
import kin.recovery.events.BroadcastManager.Listener;
import kin.recovery.events.BroadcastManagerImpl.ActionName;
