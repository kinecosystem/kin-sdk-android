...
public class RawTransaction extends Transaction {
     ...
     * Memo is an optional object that contains optional extra information. It is the responsibility of the client to
     * interpret
     * this value.
     *
     * <p>Memos can be one of the following types:</p>
     * <ul>
     * <li>MEMO_TEXT : A string encoded using either ASCII or UTF-8, up to 21-bytes long or 22-bytes long if your
     * appId is 3 letters</li>
     * <li>MEMO_ID : A 64 bit unsigned integer.</li>
     * <li>MEMO_HASH : A 32 byte hash.</li>
     * <li>MEMO_RETURN : A 32 byte hash intended to be interpreted as the hash of the transaction the sender is
     * refunding.</li>
     * </ul>
     */
    public Memo memo() {
     ...
     * Operations are executed in order as one ACID transaction, meaning that either all operations are applied or
     * none are.
