...
/**
 * @deprecated replaced by {@link kin.sdk.transactiondata.Transaction}, exists to supports backward compatibility
 * for {@link KinAccount#buildTransaction(String, BigDecimal, int, String)}
 */
@Deprecated
public class Transaction {
    ...
    public kin.base.Transaction getBaseTransaction() {
